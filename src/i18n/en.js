export default {
  ...
  interval_error: 'The update interval must be a whole number of minutes between {min} and {max}',
  ...
  notifications_limit_hint: '0 — show all changes',
  options: 'Options',
  ...
  rel_blocks: 'Blocks',
  rel_copied_from: 'Copied from',
  rel_copied_to: 'Copied to',
  rel_duplicated: 'Duplicated by',
  ...
  update_interval_hint: 'From {min} to {max} minutes',
  yes: 'Yes'
}
